...
class PropertiesMixin(object):
    ...
    def docker_db_maxcon(self):
        self._cp
        self._docker_db_maxcon = self.docker_defaults.get(
            'docker_db_maxcon', 64)
    ...
    def docker_log_level(self):
        self._cp
        self._docker_log_level = self.docker_defaults.get(
    ...
    def docker_logrotate(self):
        self._cp
        self._docker_logrotate = self.docker_defaults.get(
            'docker_logrotate', False)
    ...
    def docker_db_sslmode(self):
        self._cp
        self._docker_db_sslmode = self.docker_defaults.get(
            'docker_db_sslmode', False)
    ...
    def docker_list_db(self):
        self._cp
        self._docker_list_db = self.docker_defaults.get(
