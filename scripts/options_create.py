...
def add_options_create(parser, result_dic):
    ...
    parser_manage.add_argument(
        ...
        dest="create",
        default=False,
        help="create new site structure in %s. Name must be provided"
        % BASE_INFO.get("project_path", os.path.expanduser("projects")),
        need_name=True,
        name_valid=True,
    )
    parser_manage.add_argument(
        ...
        dest="directories",
        default=False,
        help="create local directories for site %s. option -n must be set and valid. This option is seldomly needed. Normaly directories are created when needed"
        % BASE_INFO.get("erp_server_data_path", BASE_PATH),
        need_name=True,
    )
    parser_manage.add_argument(
        "--DELETELOCAL",
        action="store_true",
        dest="delete_site_local",
        default=False,
    ...
    parser_manage.add_argument(
        "-LM",
        "--list-installed-apps-and-modules",
        action="store_true",
        dest="listinstalledapps_modules",
        default=False,
        help="list installed erp apps. Name must be provided",
        need_name=True,
        name_valid=True,
    ...
    parser_manage.add_argument(
        "-uu",
        "--dataupdate-close-conections",
        action="store_true",
        dest="dataupdate_close_connections",
        default=False,
